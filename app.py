...
# from feature_extraction.feature_extraction import FeatureExtraction
  # Assuming FeatureExtraction is a class defined in feature_extraction.py
import re
import requests
...
data = pd.read_csv('PBL_Project\dataset\phishing.csv')
...
from flask import Flask, render_template, request, redirect, url_for
# Import the FeatureExtraction class
import numpy as np
from sklearn.ensemble import GradientBoostingClassifier


# Load your trained model (gbc) and any other necessary setup here
